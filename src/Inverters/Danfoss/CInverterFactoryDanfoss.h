...
#ifndef CInverterFactoryDanfoss_H_
#define CInverterFactoryDanfoss_H_
...
class CInverterFactoryDanfoss: public IInverterFactory
{
public:
	CInverterFactoryDanfoss();
	virtual ~CInverterFactoryDanfoss();
...
#endif /* CInverterFactoryDanfoss_H_ */
